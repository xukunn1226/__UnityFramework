...
set LOG_PATH=%PROJECT_PATH%\Deployment\build_android_log.txt
...
"D:\program files\2019.3.3f1\Editor\Unity.exe" %FIXED_COMMAND% %OPTIONAL_COMMAND% -UseAPKExpansionFiles
