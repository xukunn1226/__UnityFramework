...
namespace AnimationInstancingModule.Editor
{
    ...
    /// 
    /// <summary>
    [CustomEditor(typeof(AnimationInstancingLODGenerator))]
    [DisallowMultipleComponent]
    public class AnimationInstancingLODGeneratorEditor : UnityEditor.Editor
    {
        private AnimationInstancingLODGenerator m_Target;
        ...
        {
            m_Target = (AnimationInstancingLODGenerator)target;
        }
