...
namespace Application.Runtime
{
    public class ResourceManager : SingletonMono<ResourceManager>
    {
        ...
        {
            return AssetManager.LoadAssetAsync<T>(bundleName, assetName);
        }
        ...
        //////////////////////////////////// LoadAssetBundle & UnloadAssetBundle
        ...
        //////////////////////////////////// LoadScene & LoadSceneAsync & UnloadSceneAsync
        ...
        {
            return AssetManager.ParseAssetPath(assetPath, out assetBundleName, out assetName);
        }
