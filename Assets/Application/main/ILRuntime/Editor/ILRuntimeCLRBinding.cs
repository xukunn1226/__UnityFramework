...
namespace Application.Runtime
{
    public static class ILRuntimeCLRBinding
    {
        ...
        private static void GenerateCrossbindAdapter()
        {
            ...
            using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/Application/main/ILRuntime/Adaptor/MonoBehaviourAdaptor.cs"))
            {
            ...
            using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/Application/main/ILRuntime/Adaptor/IAsyncStateMachineAdaptor.cs"))
            {
                sw.WriteLine(ILRuntime.Runtime.Enviorment.CrossBindingCodeGenerator.GenerateCrossBindingAdapterCode(
