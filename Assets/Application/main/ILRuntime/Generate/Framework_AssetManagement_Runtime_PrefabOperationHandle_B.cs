...
{
    unsafe class Framework_AssetManagement_Runtime_PrefabOperationHandle_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.AssetManagement.Runtime.PrefabOperationHandle);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.Action<Framework.AssetManagement.Runtime.PrefabOperationHandle>)};
        ...
        static StackObject* get_gameObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Framework.AssetManagement.Runtime.PrefabOperationHandle instance_of_this_method = (Framework.AssetManagement.Runtime.PrefabOperationHandle)typeof(Framework.AssetManagement.Runtime.PrefabOperationHandle).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* add_Completed_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<Framework.AssetManagement.Runtime.PrefabOperationHandle> @value = (System.Action<Framework.AssetManagement.Runtime.PrefabOperationHandle>)typeof(System.Action<Framework.AssetManagement.Runtime.PrefabOperationHandle>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
