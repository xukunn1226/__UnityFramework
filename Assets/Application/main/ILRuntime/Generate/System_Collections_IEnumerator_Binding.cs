...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_IEnumerator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, MoveNext_0);
            args = new Type[]{};
        ...
        static StackObject* MoveNext_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
