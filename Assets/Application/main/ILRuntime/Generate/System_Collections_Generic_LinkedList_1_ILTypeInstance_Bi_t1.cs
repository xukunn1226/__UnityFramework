...
{
    unsafe class System_Collections_Generic_LinkedList_1_ILTypeInstance_Binding_Enumerator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.LinkedList<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new System.Collections.Generic.LinkedList<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref System.Collections.Generic.LinkedList<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as System.Collections.Generic.LinkedList<ILRuntime.Runtime.Intepreter.ILTypeInstance>.Enumerator[];
