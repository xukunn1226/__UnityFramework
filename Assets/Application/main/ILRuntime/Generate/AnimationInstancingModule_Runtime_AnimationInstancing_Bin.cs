...
namespace ILRuntime.Runtime.Generated
{
    unsafe class AnimationInstancingModule_Runtime_AnimationInstancing_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, PlayAnimation_0);
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("set_playSpeed", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_playSpeed_1);
        ...
        static StackObject* PlayAnimation_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_playSpeed_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
