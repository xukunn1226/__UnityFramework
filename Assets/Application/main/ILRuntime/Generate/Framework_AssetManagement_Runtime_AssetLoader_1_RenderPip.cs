...
{
    unsafe class Framework_AssetManagement_Runtime_AssetLoader_1_RenderPipelineAsset_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Framework.AssetManagement.Runtime.AssetLoader<UnityEngine.Rendering.RenderPipelineAsset>);
            args = new Type[]{};
