...
{
    unsafe class Framework_AssetManagement_Runtime_AssetManagerEx_Binding
    {
        ...
        static StackObject* LoadSceneAsync_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Framework.AssetManagement.Runtime.AssetManagerEx.LoadSceneAsync(@location, @sceneMode, @activateOnLoad, @priority);
        ...
        static StackObject* LoadAsset_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Framework.AssetManagement.Runtime.AssetManagerEx.LoadAsset<UnityEngine.Rendering.RenderPipelineAsset>(@assetPath);
        ...
        static StackObject* LoadAsset_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Framework.AssetManagement.Runtime.AssetManagerEx.LoadAsset<UnityEngine.U2D.SpriteAtlas>(@assetPath);
