...
namespace ILRuntime.Runtime.Generated
{
    unsafe class DG_Tweening_ShortcutExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("DOPlayForward", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, DOPlayForward_1);
            args = new Type[]{typeof(UnityEngine.Component)};
            method = type.GetMethod("DOPlayBackwards", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, DOPlayBackwards_2);
        ...
        static StackObject* DOPlayForward_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = DG.Tweening.ShortcutExtensions.DOPlayForward(@target);
        ...
        static StackObject* DOPlayBackwards_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = DG.Tweening.ShortcutExtensions.DOPlayBackwards(@target);
