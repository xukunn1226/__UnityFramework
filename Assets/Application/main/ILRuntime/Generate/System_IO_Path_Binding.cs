...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_IO_Path_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetFileName_0);


        }


        static StackObject* GetFileName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
