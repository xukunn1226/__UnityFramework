...
{
    unsafe class Application_Runtime_CoroutineExtension_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Application.Runtime.CoroutineExtension);
        ...
        static StackObject* Start_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Application.Runtime.CoroutineExtension.Start(@enumerator);
