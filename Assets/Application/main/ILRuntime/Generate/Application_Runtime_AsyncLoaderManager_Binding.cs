...
{
    unsafe class Application_Runtime_AsyncLoaderManager_Binding
    {
        ...
        static StackObject* AsyncLoad_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action<UnityEngine.GameObject, System.Object> @cb = (System.Action<UnityEngine.GameObject, System.Object>)typeof(System.Action<UnityEngine.GameObject, System.Object>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
