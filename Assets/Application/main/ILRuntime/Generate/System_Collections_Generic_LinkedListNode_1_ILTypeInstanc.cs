...
{
    unsafe class System_Collections_Generic_LinkedListNode_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.LinkedListNode<ILRuntime.Runtime.Intepreter.ILTypeInstance>);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_Next_1);
            args = new Type[]{};
            method = type.GetMethod("get_Previous", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Previous_2);
        ...
        static StackObject* get_Next_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
