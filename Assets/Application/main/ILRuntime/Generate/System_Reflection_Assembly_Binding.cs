...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Reflection_Assembly_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("GetAssembly", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetAssembly_0);
            args = new Type[]{};
        ...
        static StackObject* GetAssembly_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Reflection.Assembly.GetAssembly(@type);
