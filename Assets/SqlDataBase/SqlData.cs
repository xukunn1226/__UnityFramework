...
namespace SQL
{
    public abstract class SqlData
    {
        ...
        public string GetDataPath(string databasePath)
        {
            ...
            return StringUtil.Concat("data source=", UnityEngine.Application.streamingAssetsPath, "/", databasePath);
#endif
#if UNITY_ANDROID
            return StringUtil.Concat("URI=file:", UnityEngine.Application.persistentDataPath, "/", databasePath);
#endif
#if UNITY_IOS
            return StringUtil.Concat("data source=", UnityEngine.Application.persistentDataPath, "/", databasePath);
#endif
        }
        #endregion
