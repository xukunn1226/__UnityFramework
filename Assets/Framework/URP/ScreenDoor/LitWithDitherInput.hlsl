#ifndef LIT_WITH_DITHER_INPUT_INCLUDED
#define LIT_WITH_DITHER_INPUT_INCLUDED
...
UNITY_DOTS_INSTANCED_PROP(float, _Transparency)
...
#define _Transparency       UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata_Transparency)
#endif
