...
{
    public class LitWithDitherGUI : BaseShaderGUI
    {
        // Properties
        private SimpleLitGUI.SimpleLitProperties shadingModelProperties;
        private MaterialProperty transparencyProp;
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            transparencyProp = FindProperty("_Transparency", properties, false);
        }
        ...
        public override void DrawSurfaceOptions(Material material)
        {
            ...
            materialEditor.MinFloatShaderProperty(transparencyProp, EditorGUIUtility.TrTextContent("Transparency", "Transparency."), 0);
        }
