...
namespace Framework.Gesture.Editor
{
    [CustomEditor(typeof(GestureEventTrigger), true)]
    public class GestureEventTriggerEditor : UnityEditor.Editor
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            string[] eventNames = Enum.GetNames(typeof(GestureEventTriggerType));
