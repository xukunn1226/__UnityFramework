    ...
    */
    ...
    CreationError CreateScripts ()
    {
        ...
        if (isStandardBlendPlayable)
        {
            ...
            string path = UnityEngine.Application.dataPath + "/" + playableName + "/Editor/" + playableName + k_PropertyDrawerSuffix + ".cs";
    ...
    {
        string path = UnityEngine.Application.dataPath + "/" + playableName + "/" + fileName + ".cs";
        using (StreamWriter writer = File.CreateText (path))
